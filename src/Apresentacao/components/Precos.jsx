        ...
        <div className="col-12 col-md-3" >
            <div className="card mt-5 mt-sm-0">
                <div className='bg-verde-escuro text-center text-white rounded'>
                    <p className='fs-3 pt-2 pb-2'>{props.periodo}</p>
                </div>
                <div className='text-center p-3'>
                    ...
                    <div className='text-center fs-6'>
                        ...
                        <Link to={`/cadastro/${props.periodo}`}>
                            <button className='border border-0 bg-verde-escuro1 fs-5 pt-2 pb-2 text-white w-75 rounded border-white mt-3 mb-3'>Contratar <i className="bi bi-arrow-right"></i></button>
                        </Link>
                    </div>
                </div>
            </div>
